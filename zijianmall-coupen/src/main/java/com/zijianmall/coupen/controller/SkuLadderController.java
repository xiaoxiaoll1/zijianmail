...
public class SkuLadderController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupen:skuladder:list")
    ...
    //@RequiresPermissions("coupen:skuladder:info")
     ...
     */
    @RequestMapping("/save")
   // @RequiresPermissions("coupen:skuladder:save")
   ...
   // @RequiresPermissions("coupen:skuladder:update")
   ...
   // @RequiresPermissions("coupen:skuladder:delete")
